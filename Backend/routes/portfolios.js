...
// @desc    Get all public portfolios with filters
// @access  Public
router.get('/', async (req, res) => {
  try {
    ...
    if (sort === 'popular') {
      sortOption = { 'analytics.totalLikes': -1, 'analytics.totalViews': -1 }
    } else if (sort === 'trending') {
      sortOption = { 'analytics.totalViews': -1, createdAt: -1 }
    }
...
// @route   GET /api/portfolios/categories
// @desc    Get portfolio categories
// @access  Public
router.get('/categories', async (req, res) => {
  try {
    const categories = [
      { value: 'graphic-design', label: 'طراحی گرافیک', count: 0 },
      { value: 'photography', label: 'عکاسی', count: 0 },
      { value: 'illustration', label: 'تصویرسازی', count: 0 },
      { value: 'web-design', label: 'طراحی وب', count: 0 },
      { value: 'ui-ux', label: 'UI/UX', count: 0 },
      { value: 'branding', label: 'برندینگ', count: 0 },
      { value: 'animation', label: 'انیمیشن', count: 0 },
      { value: 'video', label: 'ویدیو', count: 0 },
      { value: 'writing', label: 'نویسندگی', count: 0 },
      { value: 'other', label: 'سایر', count: 0 }
    ]
