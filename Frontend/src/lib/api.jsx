...
const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || 'https://artisanchat.onrender.com/api' //http://localhost:5000/api
...
export const chatsAPI = {
  ...
  updateMessage: (chatId, messageId, data) => api.put(`/chats/${chatId}/messages/${messageId}`, data),
...
export const portfoliosAPI = {
  ...
  getAllPortfolios: (params) => api.get('/portfolios', { params }),
  ...
  getCategories: () => api.get('/portfolios/categories'),
}
...
export const tasksAPI = {
  ...
  getCreatedTasks: (params) => api.get('/tasks/created-by-me', { params }),
  getStatistics: () => api.get('/tasks/statistics'),
  getOverdueTasks: (groupId) => api.get(`/tasks/group/${groupId}/overdue`),
  getDueSoonTasks: (groupId, params) => api.get(`/tasks/group/${groupId}/due-soon`, { params }),
}
